        ...
        <tr>
            <td align=center>
                ...
                <DIV id="panel_filtrowanie" class="wiekszy_panel">
                            ...
                            <B><font class='opis_paneli'>STATYSTYKI  KLIENCI  AN-FARB</font></B><br><br>

                            <FORM ACTION="statystyki_klient_anfarb.php" METHOD=POST>
                    ...
                    <td align="center">
                        <DIV align="center">
                            <TABLE style="width: 80%">
                                <TR bgcolor = #6666ff><TD id='td_kolor' class='regaly_td_font' style='width: 5%;'><B>Lp.</B></TD><TD id='td_kolor' class='regaly_td_font' style='width: 60%;'><B>KLIENT</B></TD><TD id='td_kolor' class='regaly_td_font' style='width: 20%;'><B>KILOGRAMY</B></TD><TD id='td_kolor' class='regaly_td_font' style='width: 15%;'><B> % </B></TD></TR>
                                    <?PHP
                                        ...
                                        $polocz->open(); 
                                        mysql_select_db("PRODUKCJA_FARBIARNIA") or die ("nie ma zamowienia_drukarnia");                                  
                                        $wynik = mysql_query("SELECT Klient, sum(Waga) AS 'waga_suma' FROM KARTA_TAB WHERE Data_przyjecia >= '$data_od_anfarb' AND Data_przyjecia <= '$data_do_anfarb' GROUP BY Klient ORDER BY sum(Waga) DESC;") or die ("zle pytanie zamowienia");                                                                                              
                                        ...
                                        while($rekord = mysql_fetch_assoc($wynik)){
                                            ...
                                            print"<TR><TD id='td_kolor' align = 'center' bgcolor=$kolor>$lp</TD><TD id='td_kolor' bgcolor=$kolor>$klient</TD><TD id='td_kolor' align='right' bgcolor=$kolor>$kilogramy_anfarb</TD><TD id='td_kolor' align = 'center' bgcolor=$kolor>$procent %</TD></TR>\n";
                                            $lp ++;
