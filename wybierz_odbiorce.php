...
<?PHP
                        ...
                        $rok = array('2013' => '2013','2014' => '2014', '2015' => '2015', '2016' => '2016', '2017' => '2017', '2018' => '2018', '2019' => '2019', '2020' => '2020', '2021' => '2021', '2022' => '2022', '2023' => '2023', '2024' => '2024');
...
print'<TABLE border="0" style="width: 100%; height: 100%;">';   
    ...
    print"<tr>";
        print"<td align=center>";       
                //////////////////kontener przyciski statystyki ANFARB////////////////////////////////////////////               
            if($_SESSION['uprawnienia'] == "admin_strona")
            {
                print'<div class="panel_1ogowanie">';
                    require_once "./wybierz_odbiorce.kontener_zamowienia_allegro.php";
                print'</div>';
            }
